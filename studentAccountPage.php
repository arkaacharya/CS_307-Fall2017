	...
	<div id="menu-wrapper">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="studentAccountPage.php?userName=<?php echo $userName ?>">Account</a></li>
			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="entry">
						...
						<h3 class="link"><a href="studentAccountPage.php?editBio=true&userName=<?php echo $userName; ?>">Edit Bio</a></h3>
					</div>
					<?php
						}
					?>
